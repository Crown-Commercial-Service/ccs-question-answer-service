...
COPY --from=build /tmp/build/target/ccs-question-answer-service-*.jar /app/ccs-question-answer-service.jar
...
ENTRYPOINT ["java", "-jar", "ccs-question-answer-service.jar"]